...
namespace Photoforge_Server.Migrations
{
    ...
    [Migration("20240528063117_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Photoforge_Server.Models.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Photoforge_Server.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Photoforge_Server.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Photoforge_Server.Models.Layer", b =>
                {
                    b.HasOne("Photoforge_Server.Models.Project", "Project")
                        .WithMany("Layers")
            ...
            modelBuilder.Entity("Photoforge_Server.Models.Project", b =>
                {
                    b.HasOne("Photoforge_Server.Models.User", "User")
                        .WithMany("Projects")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
